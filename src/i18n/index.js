...
let enConfig = {
  ...
  '兑换': 'Redeemed',
  '红包': 'Red Packet',
  '保存到您的EOS账号': 'Saved to your EOS account',
  '请输入您的账号': 'Please input your account',
  '请输入12位有效账号': 'Please enter a valid account',
  '账号': 'Account',
  ...
  '是': 'YES',
  '否': 'NO',
  '确定私钥已保存安全位置': 'Confirm that the private key has been saved',
  ...
  'owner key和active key相同': 'Owner key is the same as active key.',
  '红包串': 'Red Packet Code',
  ...
  '红包金额以实际转账为准': 'The amount of the red packet depends on the actual transfer',
  '塞钱进红包': 'Transfer EOS to Red Packet',
  '未领取的红包，将于转账成功24小时后发起退款': 'Unclaimed amount will be refund after 24 hours',
  ...
  '创建提示': 'Tips',
  '创建账号会扣除部分EOS，剩余部分会转入账号内': 'Creating an account will consume a small portion of EOS, and the rest will be transferred to the account',
  '离线保存': 'Save offline',
  ...
  '目前支持EOS,EGT币种、中英文版本': 'Currently EOS, EGT and Chinese and English versions are supported',
  ...
  '单个红包金额不能低于0.1EOS': 'Value of each packet Not lower than 0.1EOS',
...
let cnConfig = {
  ...
  'owner key和active key相同': 'owner key和active key相同',
  '红包串': '红包串',
  '请正确输入红包串': '请正确输入红包串',
  '创建账号成功': '创建账号成功',
  '选填': '选填',
  ...
  '单个红包金额不能低于0.1EOS': '单个红包金额不能低于0.1EOS',
  'server_1': '参数错误',
  'server_2': '红包不存在',
  'server_3': '该红包无效',
  'server_4': '查询红包失败',
