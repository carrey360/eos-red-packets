...
let enConfig = {
  ...
  '发红包': 'Send Red packet',
  '请输入': 'please enter',
  '请输入红包串号或者红包ID来领取和查看红包': 'Please enter red packet number or ID to grab and review',
  '请输入红包串号或者红包ID': 'Please enter red packet ID or number',
...
let cnConfig = {
  ...
  '发红包': '发红包',
  '请输入': '请输入',
  '请输入红包串号或者红包ID来领取和查看红包': '请输入红包串号或者红包ID来领取和查看红包',
  '请输入红包串号或者红包ID': '请输入红包串号或者红包ID',
  '请输入有效值': '请输入有效值',
